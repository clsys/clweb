    ...
    children: [
      {
        ...
        name: 'kline',
        meta: { title: '行情信息', icon: 'chart', noCache: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'choose',
        meta: { title: '自选股', icon: 'el-icon-thumb', noCache: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'trade',
        meta: { title: '量化交易', icon: 'el-icon-money', noCache: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'strategy',
        meta: { title: '策略管理', icon: 'edit', noCache: true }
      }
    ]
  },
  {
